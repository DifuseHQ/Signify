...
<div in:fade={{ duration: 300 }} out:fade={{ duration: 300 }} class="flex justify-center">
  {#if icons && card}
    <table
      ...
      cellspacing="0"
      border="0"
      style="font-family: Arial, sans-serif;font-size: 13px;color: #111827;width: 640px;background-color: {card.colours.background};line-height: 1.45;margin: 0;padding: 14px 16px;border-radius: 12px;"
    >
      <tbody>
        <tr>
          <td valign="middle" style="padding-right: 18px; border-right: 2px solid {card.colours.primary};">
                  ...
                  <td width="64" valign="middle" style="padding-right: 10px;">
                    {#if card.photos.profile}
                      <img
                        ...
                        alt={card.name}
                        style="width: 56px; height: 56px; border-radius: 50%; display: block; object-fit: cover;"
                      />
                    {/if}
                  </td>
                  <td valign="middle">
                    <p
                      style="margin: 0;font-size: 18px;font-weight: 700;color: {card.colours.primary};white-space: nowrap;"
                    >
                      {card.name}
                    </p>
                    <p
                      style="margin: 2px 0 0;font-size: 13px;font-weight: 600;color: {card.colours.text};white-space: nowrap;"
                    >
                      {card.title}
                    </p>
                    <p
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="padding-right: 16px;">
                            <a href={'tel:' + card.phone} style="color:#111827; text-decoration:none; white-space:nowrap;">
                              {card.phone}
                            </a>
                          </td>
                ...
                <tr>
                  <td style="padding-top: 6px;">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tbody>
                        <tr>
                          <td style="border-top: 1px solid {card.colours.primary}; font-size:0; line-height:0;">&nbsp;</td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
